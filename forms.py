...
class AddServerForm(FlaskForm):
    url = StringField(
        ...
        render_kw={"placeholder": "Enter URL...", "class": "form-control", "style": "max-width: 500px;"}
    )
...
class SearchForm(FlaskForm):
    q = StringField(
        'Search',
        validators=[Optional()],
        render_kw={"placeholder": "Enter Search...", "class": "form-control", "style": "max-width: 500px;"}
    )
    ...
    service_type = SelectField(
        'Service Type',
        choices=[('', 'All Types'), ('MapServer', 'Map Server'), ('FeatureServer', 'Feature Server')],
        validators=[Optional()],
        render_kw={"class": "form-control", "style": "max-width: 300px;"}
    )
